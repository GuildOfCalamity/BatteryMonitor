...
/// <summary>
/// The <see cref="CompShadow"/> control allows the creation of a DropShadow for any 
...
public sealed partial class CompShadow : UserControl
{
    ...
    public CompShadow()
    {
        ...
        DefaultStyleKey = typeof(CompShadow);
        SizeChanged += CompShadow_SizeChanged;
        ...
        // rendering on top of the content. To avoid this, CompShadow contains a Border
    ...
    /// <summary>
    /// The FrameworkElement that this <see cref="CompShadow"/> uses to create 
    ...
    public FrameworkElement CastingElement
    {
        ...
        set
        {
            if (_castingElement != null)
                _castingElement.SizeChanged -= CompShadow_SizeChanged;
